...
import (
	gobackendlogger "github.com/Japanisnmm/GoBackend101/pkg/GoBackendlogger"
...
func (r *Response) Success(code int, data any) IResponse{
	r.StatusCode =code
	r.Data = data
	gobackendlogger.InitGobackendlogger(r.Context, &r.Data).Print().Save()
	return r
}
func (r *Response)	Error(code int , traceId ,msg string) IResponse {
	...
	r.IsError =true
	gobackendlogger.InitGobackendlogger(r.Context, &r.ErrorRes).Print().Save()
	return r
